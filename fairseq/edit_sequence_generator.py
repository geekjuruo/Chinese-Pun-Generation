...
class SequenceGenerator(object):
    ...
    def generate(self, src_tokens, src_lengths, src_inserts, beam_size=None, maxlen=None, prefix_tokens=None, pun_prob=None, alter_prob=None):
        """Generate a batch of translations."""
        with torch.no_grad():
            return self._generate(src_tokens, src_lengths, src_inserts, beam_size, maxlen, prefix_tokens, pun_prob, alter_prob)

    def _generate(self, src_tokens, src_lengths, src_inserts, beam_size=None, maxlen=None, prefix_tokens=None, pun_prob=None, alter_prob=None):
        bsz, srclen = src_tokens.size()
        _, inslen = src_inserts.size()
        ...
        for model in self.models:
            ...
            if hasattr(model, 'encoder'):
                encoder_out = model.encoder(
                    ...
                    src_inserts.repeat(1, beam_size).view(-1, inslen)
                )
